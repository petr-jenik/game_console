...
OUTDIR = ./build/bin
DATADIR = ./build/data
SUBDIR = src libs/ArduinoCore-API/api libs/ArduinoCore-API/test/include libs/adafruit_driver libs/adafruit_driver/Fonts src/games src/menu src/x86 src/wifi
DIR_OBJ = ./build/obj
